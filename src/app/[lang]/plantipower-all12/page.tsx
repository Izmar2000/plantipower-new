...
export default async function ProductAll12({
    ...
    const content = {
        ...
        labelImage: isNL ? '/images/products/all12-jerrycan-nl.png' : '/images/products/label-all12-nl.png',
        heroImage: isNL ? '/images/products/all12-jerrycan-nl.png' : '/images/products/plantipower-all12-transparant.png'
    };
